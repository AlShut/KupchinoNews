...
import com.example.helen.kupchinonews.Feed
import com.example.helen.kupchinonews.commons.hide
import com.example.helen.kupchinonews.commons.inflate
import com.example.helen.kupchinonews.commons.show
import com.example.helen.kupchinonews.commons.showToast
...
class NewsFeedFragment : Fragment(), NewsFeedContract.View, PopupMenu.OnMenuItemClickListener,
    ...
    override fun onAttach(context: Context?) {
        ...
        mAppBar = (context as Feed).getAppBar()
